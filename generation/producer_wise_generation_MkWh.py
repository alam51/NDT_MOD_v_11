...
def producer_wise_gen_mkwh(from_date: str, to_date: str, folder: str) -> None:
    query_str = f"""
    ...
    # writer =
    with ExcelWriter(os.path.join(folder, f'power_producer_wise_generation_MkWh.xlsx')) as writer:
