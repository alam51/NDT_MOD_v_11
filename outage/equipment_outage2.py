...
query_str = f"""
SELECT c.name AS 'circle', g.name AS 'gmd', z.name AS 'zone', s.name AS 'substation', se.id as 'eq_id', 
se.name AS 'equipment', se.is_bus, se.is_transformer, e.date_time,
se.is_line, e.event_info, e.is_trip, e.is_scheduled, e.is_forced, e.is_project_work,
