...
df = max_ss_load_mw(from_datetime_str='2023-7-1 00:00', to_datetime_str='2023-7-31 23:00',
                    # from_hour1=8, to_hour1=12,
                    excel_path=r'')
df.to_excel(r'H:\My Drive\IMD\Monthly_Report\2023\7.July\max_ss_load_mw.xlsx')
a = 5
