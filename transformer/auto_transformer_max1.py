...
df = max_auto_transformer_load(from_datetime_str='2023-01-01 00:00', to_datetime_str='2023-01-31 23:00',
                               # from_hour1=8, to_hour1=12
                               )
a = 5
df.to_excel(r'I:\My Drive\IMD\Monthly_Report\2023\1.January\auto_transformer_max_load1.xlsx')
a = 5
